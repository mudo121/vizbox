...
class RosBackend(BackendBase):
    ...
    def __init__(self, shutdown_hook):
        ...
        self.image_sub1 = rospy.Subscriber("image_1", Image, call_callbacks_in(self.on_image, self.ros_image_to_base64), queue_size=1)
        #self.image_sub2 = rospy.Subscriber("image_2", Image, call_callbacks_in(self.on_image, self.ros_image_to_base64), queue_size=1)
        #self.image_sub3 = rospy.Subscriber("image_3", Image, call_callbacks_in(self.on_image, self.ros_image_to_base64), queue_size=1)
        #self.image_sub4 = rospy.Subscriber("image_4", Image, call_callbacks_in(self.on_image, self.ros_image_to_base64), queue_size=1)
